...
public class Modelo_Instructor extends Instructor {
    ...
    public Modelo_Instructor(int ins_codigo, String ins_areatrabajo, String descripcion, int ins_codemp, int empleado_codigo, double salario_emp, String emp_horario, int emp_codper) {
        super(ins_codigo, ins_areatrabajo, descripcion, ins_codemp, empleado_codigo, salario_emp, emp_horario, emp_codper);
    }

    public Modelo_Instructor(int ins_codigo, String ins_areatrabajo, String descripcion, int ins_codemp, int empleado_codigo, double salario_emp, String emp_horario, int emp_codper, int cod_persona, String per_cedula, String per_nombre, String per_apellido, Date per_fechaNac, String per_telefono, String per_direccion) {
        super(ins_codigo, ins_areatrabajo, descripcion, ins_codemp, empleado_codigo, salario_emp, emp_horario, emp_codper, cod_persona, per_cedula, per_nombre, per_apellido, per_fechaNac, per_telefono, per_direccion);
    }
