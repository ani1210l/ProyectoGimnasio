...
public class ModeloEmpleado extends Persona {
    ...
    public ModeloEmpleado(int cod_persona, String per_cedula, String per_nombre, String per_apellido, Date per_fechaNac, String per_telefono, String per_direccion) {
    ...
    public SQLException crearEmpleado() {
        String sql = "INSERT INTO EMPLEADO(EMP_CODIGO, EMP_CODPER,EMP_SALARIO,EMP_HORARIO) VALUES ('" + get() + "', '" + getPer_nombre() + "', '"  + "', '" + getPer_apellido() + "', '"  + getPer_fechaNac() + "', '" + getPer_telefono() + "', '"  + getPer_direccion() + "');";
